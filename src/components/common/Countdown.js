  ...
  return (
    <div className="countdown">
      ...
      <ul style={{paddingLeft: 0}}>
        <li>
          <CircularProgressbar
            value={currentTimeLeft.days}
            maxValue={totalInterval.days}
            text={`${currentTimeLeft.days} Days`}
        ...
        <li>
          <CircularProgressbar
            ...
            maxValue={24}
            text={`${currentTimeLeft.hours} Hours`}
            styles={progressStyle}
          />
        </li>
        <li>
          <CircularProgressbar
            ...
            maxValue={60}
            text={`${currentTimeLeft.minutes} Mins`}
            styles={progressStyle}
          />
        </li>
        <li>
          <CircularProgressbar
            ...
            maxValue={60}
            text={`${currentTimeLeft.seconds} Secs`}
            styles={progressStyle}
          />
        </li>
      </ul>
